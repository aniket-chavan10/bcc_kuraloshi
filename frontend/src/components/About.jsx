      ...
      <div className="mb-12 text-center">
        <div className="relative mb-6">
          <img
            ...
            className="w-full h-auto object-cover rounded-lg shadow-lg about-image"
          />
        </div>
        {imageLoaded && (
          <div className="text-gray-900 space-y-6 md:space-y-10">
            ...
            <p className="text-base text-left md:text-lg leading-relaxed about-text">{clubInfo.description}</p>
            <p className="text-base md:text-lg italic about-text">{clubInfo.tagline}</p>
