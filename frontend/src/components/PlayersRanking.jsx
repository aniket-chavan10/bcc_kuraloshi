...
import { fetchPlayersData } from "../services/api"; // Import your fetch function
import gsap from "gsap";

const PlayerRanking = () => {
  const [players, setPlayers] = useState([]);
  const [activeTab, setActiveTab] = useState("runs"); // Default to ranking by runs
  ...
  // Sort players based on the active tab
  const sortedPlayers =
    activeTab === "runs"
