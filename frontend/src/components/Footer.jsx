    ...
    <footer className="bg-zinc-900 text-white py-6 md:py-8">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6">
        <div className="flex flex-col items-center md:items-start border-b md:border-none border-zinc-600 pb-4 md:pb-0 px-4">
          ...
          <p className="text-xs md:text-sm text-center md:text-left">
            Bhairavnath Cricket Club Kuraloshi. Dedicated to promoting cricket
            and fostering sportsmanship.
          </p>
        </div>
        <div className="flex flex-col border-b md:border-none border-zinc-600 pb-4 md:pb-0 px-4">
          ...
          <p className="text-xs md:text-sm">
            Bhairavnath Cricket Club, Kuraloshi proudly represents our village
            in the Jaoli Association, competing in local and Mumbai tennis ball
            cricket tournaments.
          </p>
        </div>
        <div className="flex flex-col border-b md:border-none border-zinc-600 pb-4 md:pb-0 px-4">
          ...
          <ul className="list-none space-y-1">
            <li>
              <a
                href="/privacy-policy"
                className="text-white hover:text-zinc-400 text-xs md:text-sm"
              >
                Privacy Policy
              </a>
            </li>
        ...
        <div className="flex flex-col px-4">
          ...
          <ul className="list-none space-y-1">
            <li>
              <a
                href="mailto:kuruloshi.bcc.11@gmail.com"
                className="text-white hover:text-zinc-400 text-xs md:text-sm"
              >
                contact.bcckuraloshi@gmail.com
              </a>
            </li>
            <li>
              <a
          ...
          <ul className="list-none flex space-x-4">
            <li>
              <a
                ...
                className="text-white text-xl hover:text-zinc-400"
              >
                <FaFacebookF />
              </a>
            </li>
      ...
      <div className="container mx-auto mt-4 md:mt-6 border-t border-zinc-600 pt-4 px-4">
        <p className="text-center text-xs md:text-sm">
          &copy; {new Date().getFullYear()} Bhairavnath Cricket Club Kuraloshi |
          All Rights Reserved
        </p>
      </div>
    </footer>
